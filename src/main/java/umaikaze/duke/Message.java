/**
 * A library class containing most of the sentences that can be shown on the Ui
 */

package umaikaze.duke;

public class Message {
    public static final String GREETING_LOADED = "how may i serve u today nya?";
    public static final String GREETING_EMPTY_SAVE = "save data is empty, we will start fwesh (・`ω´・)";
    public static final String GREETING_GOODBYE = "bye (・`ω´・) hope to see you again soon!";
    public static final String BONUS = "MEOWWWWWWWWWWWWWWWWWW";
    public static final String LIST = "Hewe are the tasks in youw list:";
    ...
    public static final String EXCEPTION_UNKNOWN_COMMAND = "OOPS oωo  I'm sowwy, but I don't knyow what that " +
            "means ^;;ω;;^";
    public static final String EXCEPTION_DESCRIPTION_EMPTY = "descwiption must nyot be empty >w<";
    public static final String EXCEPTION_TIMING_NOT_FOUND = "i couwdn't find the timing in youw instwuctions," +
